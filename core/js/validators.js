...
function meu_callback(conteudo) {
  if (!("erro" in conteudo)) {
    ...
    let address = conteudo.logradouro +', ' + conteudo.bairro +', ' + conteudo.localidade;

    xhr.open('GET', 'https://nominatim.openstreetmap.org/?format=json&addressdetails=1&q=' + address + '&format=json&limit=1');
